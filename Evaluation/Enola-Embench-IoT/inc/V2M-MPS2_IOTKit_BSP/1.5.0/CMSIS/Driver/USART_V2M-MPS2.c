 ...
 * Project:      UART Driver for ARM IOTKIT device
 * --------------------------------------------------------------------------
 ...
 *    Removed ARMCLANG warnings
 *  Version 1.0.3
 *    Updated use of secure regosters
 */
...
// USART0
  ...
  #define IOTKIT_UART0_REGISTER IOTKIT_SECURE_UART0
  #define IOTKIT_GPIO1_REGISTER IOTKIT_SECURE_GPIO1
#else
  #define IOTKIT_UART0_REGISTER IOTKIT_UART0
  #define IOTKIT_GPIO1_REGISTER IOTKIT_GPIO1
#endif
...
static PIN                 USART0_pin_rx       = { IOTKIT_GPIO1_REGISTER, 0U };
static PIN                 USART0_pin_tx       = { IOTKIT_GPIO1_REGISTER, 1U };
...
#if defined __USE_SECURE
  #define IOTKIT_UART1_REGISTER IOTKIT_SECURE_UART1
  #define IOTKIT_GPIO1_REGISTER IOTKIT_SECURE_GPIO1
#else
  #define IOTKIT_UART1_REGISTER IOTKIT_UART1
  #define IOTKIT_GPIO1_REGISTER IOTKIT_GPIO1
#endif
...
static PIN                 USART1_pin_rx       = { IOTKIT_GPIO1_REGISTER, 7U };
static PIN                 USART1_pin_tx       = { IOTKIT_GPIO1_REGISTER, 8U };
...
#if defined __USE_SECURE
  #define IOTKIT_UART2_REGISTER IOTKIT_SECURE_UART2
  #define IOTKIT_GPIO1_REGISTER IOTKIT_SECURE_GPIO1
#else
  #define IOTKIT_UART2_REGISTER IOTKIT_UART2
  #define IOTKIT_GPIO1_REGISTER IOTKIT_GPIO1
#endif
...
static PIN                 USART2_pin_rx       = { IOTKIT_GPIO1_REGISTER, 0U };
static PIN                 USART2_pin_tx       = { IOTKIT_GPIO1_REGISTER, 1U };
...
#if defined __USE_SECURE
  #define IOTKIT_UART3_REGISTER IOTKIT_SECURE_UART3
  #define IOTKIT_GPIO0_REGISTER IOTKIT_SECURE_GPIO0
#else
  #define IOTKIT_UART3_REGISTER IOTKIT_UART3
  #define IOTKIT_GPIO0_REGISTER IOTKIT_GPIO0
#endif
...
static PIN                 USART3_pin_rx       = { IOTKIT_GPIO0_REGISTER, 0u };
static PIN                 USART3_pin_tx       = { IOTKIT_GPIO0_REGISTER, 4u };
...
static int32_t USART_Send (const void            *data,
  ...
  if ((usart->info->status.tx_busy != 0U) ||
     ((usart->reg->STATE & IOTKIT_UART_STATE_TXBF_Msk) != 0U)) {
  ...
  // TX interrupt enable
  usart->reg->CTRL |= IOTKIT_UART_CTRL_TXIRQEN_Msk;
...
static int32_t USART_Receive (      void            *data,
  ...
  if ((usart->info->status.rx_busy != 0U) ||
     ((usart->reg->STATE & IOTKIT_UART_STATE_RXBF_Msk) != 0U)) {
    return ARM_DRIVER_ERROR_BUSY;
  }
  ...
  // RX interrupt enable
  usart->reg->CTRL |= IOTKIT_UART_CTRL_RXIRQEN_Msk;
...
static int32_t USART_Control (      uint32_t          control,
  ...
  switch (control & ARM_USART_CONTROL_Msk) {
    ...
    case ARM_USART_CONTROL_TX:
      ...
      // Transmitter enable
      usart->reg->CTRL |= ((arg & 1U) << IOTKIT_UART_CTRL_TXEN_Pos);
      return ARM_DRIVER_OK;
    ...
    case ARM_USART_CONTROL_RX:
      ...
      // Receiver enable
      usart->reg->CTRL |= ((arg & 1U) << IOTKIT_UART_CTRL_RXEN_Pos);
      return ARM_DRIVER_OK;
    default: break;
  }
  ...
  if ((usart->info->status.tx_busy != 0U) ||
      (usart->info->status.rx_busy != 0U) ||
     ((usart->reg->STATE & (IOTKIT_UART_STATE_TXBF_Msk | IOTKIT_UART_STATE_RXBF_Msk)) != 0U)) {
    return ARM_DRIVER_ERROR_BUSY;
  }
